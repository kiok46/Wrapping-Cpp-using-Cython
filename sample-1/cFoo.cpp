...
static PyTypeObject *__pyx_ptype_4cFoo_cFoo = 0;
...
static int __pyx_pf_4cFoo_4cFoo___cinit__(struct __pyx_obj_4cFoo_cFoo *__pyx_v_self); /* proto */
static void __pyx_pf_4cFoo_4cFoo_2__dealloc__(struct __pyx_obj_4cFoo_cFoo *__pyx_v_self); /* proto */
static PyObject *__pyx_tp_new_4cFoo_cFoo(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_4cFoo_4cFoo_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_4cFoo_4cFoo_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  ...
  __pyx_r = __pyx_pf_4cFoo_4cFoo___cinit__(((struct __pyx_obj_4cFoo_cFoo *)__pyx_v_self));
...
static int __pyx_pf_4cFoo_4cFoo___cinit__(struct __pyx_obj_4cFoo_cFoo *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static void __pyx_pw_4cFoo_4cFoo_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_4cFoo_4cFoo_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_4cFoo_4cFoo_2__dealloc__(((struct __pyx_obj_4cFoo_cFoo *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_4cFoo_4cFoo_2__dealloc__(struct __pyx_obj_4cFoo_cFoo *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
...
static PyObject *__pyx_tp_new_4cFoo_cFoo(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_4cFoo_4cFoo_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_4cFoo_cFoo(PyObject *o) {
  ...
  #endif
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pw_4cFoo_4cFoo_3__dealloc__(o);
    --Py_REFCNT(o);
...
static PyMethodDef __pyx_methods_4cFoo_cFoo[] = {
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_4cFoo_cFoo = {
  PyVarObject_HEAD_INIT(0, 0)
  "cFoo.cFoo", /*tp_name*/
  sizeof(struct __pyx_obj_4cFoo_cFoo), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_4cFoo_cFoo, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_4cFoo_cFoo, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_4cFoo_cFoo, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcFoo(void); /*proto*/
PyMODINIT_FUNC initcFoo(void)
#else
PyMODINIT_FUNC PyInit_cFoo(void); /*proto*/
PyMODINIT_FUNC PyInit_cFoo(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cFoo(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cFoo")) {
      if (unlikely(PyDict_SetItemString(modules, "cFoo", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_4cFoo_cFoo) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_4cFoo_cFoo.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "cFoo", (PyObject *)&__pyx_type_4cFoo_cFoo) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4cFoo_cFoo = &__pyx_type_4cFoo_cFoo;
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cFoo", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
